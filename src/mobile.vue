<template>
    <div class="max-pdf">
        ...
        <slot>
            <div class="bar-wrap" @mousemove="parentDefault($event)">
                <div class="fixed"  v-show="isInitPage">
                    ...
                    <div @click="next" :class="{active: page >= pagesCount}">
        ...
        <!-- 更多弹窗 -->
        <transition name="my">
            <div class="mask-wrap" v-if="showMore" @click="showMore = false"></div>
        </transition>
        <transition name="Goleft">
            <div class="mask-right" v-if="showMore">
                <!-- 分类
                    常规：全屏、打开、下载、
                    旋转：
                    文档属性
...
<style scoped>
    ...
    .Goleft-enter,.Goleft-leave-to{
        transform: translateX(60%);
    }
    .Goleft-enter-active,.Goleft-leave-active{
